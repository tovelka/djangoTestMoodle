"""
Django settings for tovelka project.
...
SECRET_KEY = os.getenv("SECRET_KEY") or "42"
...
WSGI_APPLICATION = "tovelka.wsgi.application"
...
PYLTI_CONFIG = {
    "consumers": {"moodle_test_key": {"secret": "moodle_test_secret"}},
    "method_hooks": {
